...
class RepoVersionTests(unittest.TestCase):
    """Test that the `rules_kconfig` versions match for WORKSPACE and bzlmod."""
    ...
    def test_versions(self) -> None:
        ...
        version_bzl = rlocation(runfiles, "rules_kconfig/version.bzl")
        ...
        module_bazel = rlocation(runfiles, "rules_kconfig/MODULE.bazel")
        module_version = re.findall(
            r'module\(\n\s+name = "rules_kconfig",\n\s+version = "([\d\w\.]+)",\n\)',
